...
Soll die Speicherung in einem anderen Ordner erfolgen, so kann dieser mit dem \framebox{Wähle...}--Button rechts unten gewählt werden.

Der \framebox{Sichern}--Button sichert die Datei mit allen gewählten Information (s.a. Abschnitt \emph{Einstellungen}) und wird anschließend deaktiviert. Erst bei Änderungen wird dieser Button wieder aktiviert.
